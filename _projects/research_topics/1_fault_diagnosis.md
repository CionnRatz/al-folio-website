...
Let us try to include a reference here {% cite Ferrari_2012aa --file papers%}.
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img class="img-fluid rounded" src="{{ '/assets/img/projects/1_fault_diagnosis/thresholds_comparison.png' | relative_url }}" alt="" title="Thresholds comparison"/>
    </div>
</div>
<div class="caption--figure">
